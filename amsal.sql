...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2022 at 06:34 PM
...
--
ALTER TABLE `register_pelaksanaan`
  MODIFY `pelaksanaan_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `register_surat`
  MODIFY `register_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `sys_user_online`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'SessionId (by system)', AUTO_INCREMENT=154;
